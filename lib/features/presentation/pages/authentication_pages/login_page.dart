...
import '../../widgets/left_top_blue_shadow.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        padding: EdgeInsets.symmetric(vertical: AppConstants.constantsAppPadding,horizontal: AppConstants.constantsAppPadding),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
